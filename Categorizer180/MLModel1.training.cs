...
namespace Categorizer180
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\jbmoya\source\repos\Categorizer180\Categorizer180\Datos\DataSet_01.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"input",outputColumnName:@"input")      
